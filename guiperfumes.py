...
class FramePerfumes ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"Perfumes", pos = wx.DefaultPosition, size = wx.Size( 500,300 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
		...
		self.m_staticText5 = wx.StaticText( self, wx.ID_ANY, u"Nome:         ", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_staticText6 = wx.StaticText( self, wx.ID_ANY, u"Quantidade:", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText6.Wrap( -1 )

		bSizer16.Add( self.m_staticText6, 0, wx.ALL, 5 )

		self.spinQuantidade = wx.SpinCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.SP_ARROW_KEYS, 0, 500, 0 )
		bSizer16.Add( self.spinQuantidade, 1, wx.ALL, 5 )
		...
		self.m_staticText7 = wx.StaticText( self, wx.ID_ANY, u"Volume:       ", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText7.Wrap( -1 )

		bSizer17.Add( self.m_staticText7, 0, wx.ALL, 5 )

		self.searchVolume = wx.SearchCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		self.searchVolume.ShowSearchButton( True )
		self.searchVolume.ShowCancelButton( True )
		bSizer17.Add( self.searchVolume, 1, wx.ALL, 5 )
		...
		bSizer18.Add( self.m_staticText8, 0, wx.ALL, 5 )

		self.searchMarca = wx.SearchCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		self.searchMarca.ShowSearchButton( True )
		self.searchMarca.ShowCancelButton( True )
		bSizer18.Add( self.searchMarca, 1, wx.ALL, 5 )
		...
		self.m_staticText9 = wx.StaticText( self, wx.ID_ANY, u"Fixação:       ", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText9.Wrap( -1 )

		bSizer19.Add( self.m_staticText9, 0, wx.ALL, 5 )

		self.searchFixacao = wx.SearchCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		self.searchFixacao.ShowSearchButton( True )
		self.searchFixacao.ShowCancelButton( True )
		bSizer19.Add( self.searchFixacao, 1, wx.ALL, 5 )
		...
		# Connect Events
		self.Bind( wx.EVT_SHOW, self.exibirFormPerfumes )
